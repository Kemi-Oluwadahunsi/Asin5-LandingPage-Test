  ...
  return (
    <div className="bg-[#F4F4F4] xl:px-[10rem] lg:px-[6rem] px-4 lg:py-[3rem] py-8 flex flex-col gap-[3rem]">
      <div className="flex flex-col gap-4 text-center justify-center">
        <h1 className="text-[#212121] lg:text-[3em] xl:text-[4rem] text-[1.1rem] font-medium leading-snug mx-auto">
          Our Concept Innovations
        </h1>
        <p className="xl:w-[80%] text-sm lg:text-base mx-auto">
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-4 lg:gap-[2em] xl:gap-[4rem] w-full">
        <div className="bg-white flex flex-col gap-4 lg:gap-8 px-4 xl:px-8 py-4 flex-1 rounded-2xl text-center">
